  ...
  return (
    <div>
      ...
      <section className="p-6 text-center mt-56">
        <h1 className="text-5xl mb-4 mt-44 italic text-left ml-52 text-verde_turquesa">
          Blog
        </h1>
        <h2 className="text-5xl font-bold mt-4 text-left ml-52 text-verde_turquesa">
          NOTICIAS Y ARTICULOS RECIENTES
        </h2>
        <div className="flex justify-center mt-6 space-x-52">
          <Link
            to="/blog/detalle/bambu"
            className="max-w-3xl rounded overflow-hidden shadow-lg m-24 transform transition-transform duration-300 hover:scale-105"
          >
