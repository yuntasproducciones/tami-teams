...
import imagenGrande from "../../../public/assets/images/Productos/Selladora de Botellas.webp";
            ...
            <div className="flex flex-col items-center lg:flex-row lg:items-center lg:justify-evenly mb-[100px] lg:w-full">
              ...
              <div className="flex flex-col w-full max-w-[375px] sm:max-w-[550px] lg:max-w-[450px] xl:max-w-[500px] 2xl:max-w-[600px]">
                ...
                <div className="flex flex-col items-start text-start mb-[40px]">
                  ...
                  <p>
                    Utiliza el principio de inducción electromagnética para
                    producir un alto calor instantáneo para derretir el papel de
                    aluminio que luego se adhiere al agujero de la Botella
                  </p>
                </div>
                {/* botones */}
                ...
                <div className="flex flex-row items-start text-start bg-gray-200 rounded-bl-2xl rounded-br-2xl p-[15px] sm:p-[20px]">
                  ...
                  <div>
                    <p>
                      <span className="bg-verde_turquesa text-white text-[8px] px-[8px] py-[5px] rounded-2xl">
                        H
                      </span>{" "}
                      Altura: 11.5 cm
                    </p>
                    <p>
                      <span className="bg-verde_turquesa text-white text-[8px] px-[9px] py-[5px] rounded-2xl">
                        L
                      </span>{" "}
                      Longitud: 28 cm
                    </p>
